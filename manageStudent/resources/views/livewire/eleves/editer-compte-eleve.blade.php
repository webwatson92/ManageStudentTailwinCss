<div class="p-2 bg-white shadow-sm">
    <form action="" method="post" wire:submit.prevent="modifierEleve()">
       @csrf
       @method('post')
       ...
       <div class="p-5">
           ...
           <input wire:model="matricule" type="text" disabled="disabled" placeholder="Ex: 06042564G" class="block mt-1 
