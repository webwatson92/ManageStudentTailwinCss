<div class="p-2 bg-white shadow-sm">
    <form action="" method="post" wire:submit.prevent="modifierEleveDeClasse()">
       @csrf
       @method('post')
       ...
       <div class="p-5">
            ...
            <input wire:model="matricule" type="text" readonly class="block mt-1 
       ...
       <div class="p-5 flex justify-between items-center">
           ...
           <button type="submit" class="bg-blue-400 p-3 rounded-sm text-white">{{ __("Changer l'élève de classe") }}</button>
       </div>
    </form>
</div>