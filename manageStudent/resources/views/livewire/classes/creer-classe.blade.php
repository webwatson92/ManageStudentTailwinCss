<div class="p-2 bg-white shadow-sm">
    <form action="" method="post" wire:submit.prevent="ajouterClasse()">
       @csrf
       @method('post')
       ...
       <div class="p-5 flex justify-between items-center">
           ...
           <button type="submit" class="bg-blue-400 p-3 rounded-sm text-white">Ajouter une classe</button>
       </div>
    </form>
</div>